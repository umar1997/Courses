...
def Listen(port, knownPort): 
# Think of this as the part that chooses what it can do after joining
	global YourNode
...
def tellAffectedPort(last, now, code, change): 
# Telling the an existing node that its previous or next might have changed 
